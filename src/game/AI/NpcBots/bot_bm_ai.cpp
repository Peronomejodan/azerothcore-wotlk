...
public:
    ...
    public:
        ...
        void MirrorImageStart()
        {
            ...
            DisappearEvent* devent = new DisappearEvent(me->GetGUIDObject());
        ...
        void MirrorImageMid()
        {
            ...
            //INVISIBLE!
            //EVENT
            DelayedIllusionSummonEvent* disevent = new DelayedIllusionSummonEvent(me->GetGUIDObject());
        ...
        void MirrorImageFinish()
        {
            ...
            for (uint8 i = 0; i != illusionsCount; ++i)
            {
                ...
                _illusionGuids.push_back(illusion->GetGUIDObject());
            }
        ...
        void CriticalStrike(Unit* target, bool windwalk = false)
        {
            ...
            DelayedMeleeDamageEvent* dmdevent = new DelayedMeleeDamageEvent(me->GetGUIDObject(), target->GetGUIDObject(), windwalk);
        ...
        {
            EventTerminateEvent* etevent = new EventTerminateEvent(me->GetGUIDObject());
