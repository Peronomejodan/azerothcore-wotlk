...
public:
    ...
    struct shaman_botAI : public bot_minion_ai
    {
        ...
        bool doCast(Unit* victim, uint32 spellId, bool triggered = false)
        {
            ...
            bool result = bot_ai::doCast(victim, spellId, triggered, me->GetGUIDObject());
        ...
        void CheckHexy(uint32 diff)
        {
            ...
            {
                Hexy = FindAffectedTarget(GetSpell(HEX_1), me->GetGUIDObject());
                HexyCheckTimer = 2000;
            }
        }
        ...
        void CheckEarthy(uint32 diff)
        {
            ...
            {
                Unit* u = FindAffectedTarget(GetSpell(EARTH_SHIELD_1), me->GetGUIDObject(), 90.f, 3);
        ...
        void OnBotSummon(Creature* summon)
        {
            ...
            _totems[slot].first = summon->GetGUIDObject();
